            ...
            header={
                <div className="flex items-center justify-between flex-wrap gap-2">
                    <div>
                        ...
                        <p className="text-xs text-slate-400 mt-0.5">{battle.created_at} · seed: {battle.random_seed}</p>
                    </div>
                    <div className="flex gap-2">
                        <Link
                            href={route('battles.index')}
                            className="flex items-center gap-1 rounded-lg border border-slate-600 px-4 py-2 text-sm font-medium text-slate-300 hover:bg-slate-700 transition-colors"
                        >
